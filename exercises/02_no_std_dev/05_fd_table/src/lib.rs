...
impl FdTable {
    ...
    pub fn alloc(&mut self, file: Arc<dyn File>) -> usize {
        // TODO
        if let Some(idx) = self.fds.iter().position(|o| o.is_none()) {
    ...
    pub fn count(&self) -> usize {
        // TODO
        self.fds.iter().filter(|o| o.is_some()).count()
    }
}
